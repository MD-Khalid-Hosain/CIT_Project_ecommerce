...
<head>
    ...
    <!-- flaticon.css -->
    <link rel="stylesheet" href="{{ asset('frontend_assets/assets/css/flaticon.css') }}">
    <!-- jquery-ui.css -->
    <link rel="stylesheet" href="{{ asset('frontend_assets/assets/css/jquery-ui.css') }}">
    <!-- metisMenu.min.css -->
    <link rel="stylesheet" href="{{ asset('frontend_assets/assets/css/metisMenu.min.css') }}">
    <!-- swiper.min.css -->
    <link rel="stylesheet" href="{{ asset('frontend_assets/assets/css/swiper.min.css') }}">
    <!-- style css -->
...
<body>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <ul class="d-flex header-contact">
                            <li><i class="fa fa-phone"></i> +8801762501345</li>
                            <li><i class="fa fa-envelope"></i> belashegolpo2@gmail.com</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-12">
                    ...
                    <div class="col-lg-7 d-none d-lg-block">
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li class="@yield('contact')"><a href="{{ url('contact/page') }}">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
    ...
    <script src="{{ asset('frontend_assets/assets/js/vendor/jquery-2.2.4.min.js') }}"></script>
    <!-- bootstrap js -->
    ...
    <!-- scrollup.js -->
    <script src="{{ asset('frontend_assets/assets/js/scrollup.js') }}"></script>
    <!-- isotope.pkgd.min.js -->
    ...
    <!-- jquery.zoom.min.js -->
    <script src="{{ asset('frontend_assets/assets/js/jquery.zoom.min.js') }}"></script>
    <!-- countdown.js -->
    <script src="{{ asset('frontend_assets/assets/js/countdown.js') }}"></script>
    <!-- swiper.min.js -->
    <script src="{{ asset('frontend_assets/assets/js/swiper.min.js') }}"></script>
    <!-- metisMenu.min.js -->
    <script src="{{ asset('frontend_assets/assets/js/metisMenu.min.js') }}"></script>
    <!-- mailchimp.js -->
    <script src="{{ asset('frontend_assets/assets/js/mailchimp.js') }}"></script>
    <!-- jquery-ui.min.js -->
